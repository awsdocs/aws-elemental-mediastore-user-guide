...
1. In CloudFront, create a distribution that is [configured to serve content from AWS Elemental MediaStore](http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/on-demand-video.html#on-demand-streaming-mediastore)\. You will need the information that you collected in the preceding step\.